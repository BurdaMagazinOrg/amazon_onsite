...
class AopItemController extends ControllerBase {
   ...
   *
   * @param \Drupal\amazon_onsite\Entity\AopItemInterface $aop_item
   *   A AOP RSS Item object.
   *
   * @return array
   *   An array as expected by drupal_render().
   */
  public function revisionOverview(AopItemInterface $aop_item) {
    ...
    foreach (array_reverse($vids) as $vid) {
      /** @var \Drupal\amazon_onsite\AopItemInterface $revision */
