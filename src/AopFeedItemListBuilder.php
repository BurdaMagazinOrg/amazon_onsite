...
/**
 * Provides a list controller for the aop feed item entity type.
 */
class AopFeedItemListBuilder extends EntityListBuilder {
...
#    \Drupal::service(‘serializer’)->serialize($data, ‘xml’);
  ...
  public function buildRow(EntityInterface $entity) {
    /* @var $entity \Drupal\amazon_onsite\AopFeedItemInterface */
    $row['id'] = $entity->id();
